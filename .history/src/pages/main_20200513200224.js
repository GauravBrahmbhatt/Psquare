...
class main extends Component {
  ...
  render(){
    ...
    <article class="card">
      ...
      <p class="category category__01"><p class="category category__01" level="6">Level 1</p>
    </article>
    ...
    <article class="card">
      ...
      <p class="category category__04">Level 4</p>
    ...
    <article class="card">
      ...
      <button ><Link to="/testpage"><p class="category category__01" level="6">Level 6</p></Link></button>
