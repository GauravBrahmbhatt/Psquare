...
class main extends Component {
  ...
  render(){
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="1"><p class="category category__01"><NextPage></NextPage>Level 1</p></Link>
    </article>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="5"><p class="category category__02">Level 5</p></Link>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="6"><p class="category category__01" >Level 6</p></Link>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="7"><p class="category category__03">Level 7</p></Link>
