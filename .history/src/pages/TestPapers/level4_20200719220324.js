...
//share abacselection use componentdidMount and autofill the questionsus or mental math via props
//based on the 
class level4 extends Component {
  ...
  abacus = () => {
    ...
    if (this.state.qa.length >= 25 && this.state.qa.length < 40) {
      type="div"
      console.log("Div");
      do {
  ...
  mentalmath = () => {
    ...
    if (
      ...
      console.log("Length", this.state.qa.length);
      console.log("Div");
      type="div"
      do {
        num1 = random3D(start2D);
