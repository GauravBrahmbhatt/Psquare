      ...
      <div>Results:
          ...
          <div>
              ...
              {data.map((res,index)=>( 
                  ...
                  <React.Fragment>
                      { this.state.answers[index] === Number(res.a) 
                      ? 
                      <i class="fa fa-check" aria-hidden="true"> {this.state.answers[index]}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i> 
                      :
                      <i class="fa fa-times" aria-hidden="true"> {res.a}{this.state.answers[index]}&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</i>
                      }
                  </React.Fragment>
              ))}</div>
