...
class main extends Component {
  ...
  render(){
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="2"></Link><p class="category category__02">Level 2</p>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="3"></Link><p class="category category__03">Level 3</p>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="4"></Link><p class="category category__04">Level 4</p>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="5"></Link><p class="category category__02">Level 5</p>
    ...
    <article class="card">
      ...
      <Link to="/testpage" level="6"></Link><p class="category category__03">Level 7</p>
    ...
    <article class="card">
      ...
      <p class="category category__04">Level 8</p>
