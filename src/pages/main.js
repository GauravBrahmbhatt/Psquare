  ...
  render() {
    ...
    return (
        ...
        <div className="row__contentmain">
          <Link to="/testpage?l=1" level="1">
                  <article className="card">
                    <picture className="thumbnail">
                      <img className="card__icon" src={image} alt="" />
                    </picture>
                      <p className="card__text">Term 1</p>
                  </article>
            </Link>
            ...
            <Link to="/testpage?l=2" level="2">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 2</p>
                  </article>
            </Link>
            ...
            <Link to="/testpage?l=3" level="3">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 3</p>
                  </article>
            </Link>
            ...
            <Link to="/testpage?l=4" level="4">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 4</p>
                  </article>
            </Link>
            ...
            <Link to="/testpage?l=5" level="5">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 5</p>
                  </article>
            </Link>
            ...
            <Link to="/testpage?l=6" level="6">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 6</p>
            ...
            <Link to="/testpage?l=7" level="7">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 7</p>
                  </article>
            </Link> 
            ...
            <Link to="/testpage?l=8" level="8">
                  <article className="card">
                    <picture className="thumbnail">
                      ...
                      <p className="card__text">Term 8</p>
                  </article>
            </Link>
            </div>
